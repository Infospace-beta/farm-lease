        ...
        <LesseeHeader
          ...
          rightContent={
            <div className="flex bg-gray-50 rounded-lg border border-gray-200 p-1 shadow-sm">
              ...
              <button className="px-3 lg:px-4 py-2 bg-forest-green text-white rounded-md text-xs font-bold uppercase tracking-wide shadow-sm">
                History
              </button>
            </div>
          }
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-soft overflow-hidden flex flex-col">
              ...
              <div className="p-6 lg:p-8 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white">
                <div>
                  <h3 className="font-bold text-2xl text-earth-brown mb-1">
                    Prediction History
                  </h3>
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center ${getColorClasses(item.cropColor)}`}
                              >
                                <CropIcon size={18} />
                              </div>
                          ...
                          <td className="px-6 py-4 text-center">
                            <span
                              className={`font-bold font-display ${getMatchColor(item.match)}`}
                            >
                              {item.match}%
                            </span>
                          </td>
