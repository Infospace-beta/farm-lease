  ...
  const products = [
    {
      ...
      description:
        "Premium NPK 23:23:0 blend enriched with Zinc and Boron for maize planting. 50kg bag.",
      price: 3500,
      rating: 4.8,
      image:
    ...
    },
    {
      ...
      categoryLabel: "Seeds",
      description:
        "High yield, drought tolerant variety suitable for medium to high altitude areas. 2kg pack.",
      price: 850,
      rating: 4.9,
      image:
    ...
    },
    {
      ...
      description:
        "Systemic herbicide for effective weed control. 1 Liter concentrate.",
      price: 1200,
      rating: 4.5,
      image:
    ...
    },
    {
      ...
      description:
        "Heavy duty manual sprayer with stainless steel lance and multiple nozzle attachments.",
      price: 4800,
      rating: 4.7,
      image:
    ...
    },
    {
      ...
      categoryLabel: "Fertilizer",
      description:
        "Calcium Ammonium Nitrate for top dressing maize and vegetables. 50kg bag.",
      price: 3200,
      rating: 4.6,
      image:
    ...
    },
    {
      ...
      categoryLabel: "Seeds",
      description:
        "Pack of 5 including Kale, Spinach, Tomato, Onion, and Coriander. Starter pack.",
      price: 450,
      rating: 4.3,
      image:
        "https://images.unsplash.com/photo-1587049352846-4a222e784589?w=800&q=80",
      isTopRated: false,
    },
  ];
          ...
          rightContent={
            <div className="flex items-center gap-3">
              ...
              <div className="relative w-48 lg:w-64 group hidden md:block">
                <Search
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-forest-green transition-colors"
                  size={18}
                />
                <input
                  type="text"
