...
export default function HomePage() {
  return (
    <div className="antialiased bg-[#f8fafc] text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#0f392b] rounded-xl flex items-center justify-center shadow-lg">
                <span className="material-symbols-outlined text-[#13ec80] text-2xl">grid_view</span>
              </div>
              <span
                className="text-2xl font-bold text-[#0f392b] tracking-tight"
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/lessee/browse" className="text-gray-600 hover:text-[#16a34a] font-medium transition-colors text-sm">
                Find Land
              </Link>
              <a href="#ai-predictor" className="text-gray-600 hover:text-[#16a34a] font-medium transition-colors text-sm">
                AI Predictor
              </a>
              <Link href="/login" className="text-gray-600 hover:text-[#16a34a] font-medium transition-colors text-sm">
                Agro-Dealers
              </Link>
              <a href="#about" className="text-gray-600 hover:text-[#16a34a] font-medium transition-colors text-sm">
                About Us
              </a>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="hidden md:block text-sm font-semibold text-gray-600 hover:text-[#16a34a] transition-colors">
                Log In
              </Link>
              <Link
                href="/signup"
                className="bg-[#0f392b] hover:bg-emerald-900 text-white px-6 py-2.5 rounded-full font-medium transition-all shadow-lg text-sm flex items-center gap-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 text-[#16a34a] text-xs font-semibold uppercase tracking-wider mb-8">
                <span className="w-2 h-2 rounded-full bg-[#16a34a] animate-pulse" />
                AI-Driven Agriculture
              </div>
              <h1
                className="text-5xl lg:text-7xl font-bold text-[#0f392b] mb-6 leading-tight"
                style={{ fontFamily: "var(--font-playfair)" }}
              >
                Precision Farming,{" "}
                <br />
                <span className="text-[#16a34a]">Data-Backed Leasing.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/signup"
                  className="bg-[#0f392b] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-emerald-900 transition-all shadow-xl flex items-center justify-center gap-2"
                >
                  Start Exploring
                ...
                <Link
                  href="/signup"
                  className="px-8 py-4 rounded-full font-medium text-lg text-[#0f392b] border border-gray-200 hover:bg-white hover:border-gray-300 transition-all bg-white/50 backdrop-blur-sm flex items-center justify-center gap-2"
                >
                  List Your Land
                </Link>
              </div>
              ...
              <div className="mt-12 flex items-center gap-8 border-t border-gray-200 pt-8">
                <div>
                  <p className="text-3xl font-bold text-[#0f392b]">98%</p>
                  <p className="text-sm text-gray-500 font-medium">Predictive Accuracy</p>
                </div>
                <div className="h-10 w-px bg-gray-200" />
                <div>
                  <p className="text-3xl font-bold text-[#0f392b]">50k+</p>
            ...
            <div className="relative">
              <div className="relative rounded-[24px] overflow-hidden shadow-2xl group">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#0f392b]/40 to-transparent mix-blend-multiply z-10" />
                ...
                <div className="absolute bottom-8 left-8 right-8 z-20 p-6 rounded-2xl border border-white/20 shadow-lg backdrop-blur-xl bg-white/90">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="text-[#0f392b] font-bold">Soil Analysis #842</h3>
              ...
              {/* Glow orbs */}
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#16a34a]/10 rounded-full blur-3xl -z-10" />
      ...
      <section className="py-20 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-8 rounded-[24px] bg-gray-50 border border-gray-100 hover:border-[#5d4037]/30 hover:shadow-lg transition-all group">
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-gray-100 shadow-sm group-hover:scale-110 transition-transform">
                  <span className="material-symbols-outlined text-[#5d4037] text-2xl">landscape</span>
                </div>
                <span className="text-[#5d4037] bg-[#5d4037]/10 px-3 py-1 rounded-full text-xs font-bold">LEASING</span>
              </div>
            ...
            <div className="p-8 rounded-[24px] bg-[#0f392b] text-white shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-32 bg-[#16a34a]/20 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />
            ...
            <div className="p-8 rounded-[24px] bg-gray-50 border border-gray-100 hover:border-[#5d4037]/30 hover:shadow-lg transition-all group">
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-gray-100 shadow-sm group-hover:scale-110 transition-transform">
                  <span className="material-symbols-outlined text-[#5d4037] text-2xl">lock_person</span>
                </div>
                <span className="text-[#5d4037] bg-[#5d4037]/10 px-3 py-1 rounded-full text-xs font-bold">SECURITY</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "var(--font-playfair)" }}>
                Secure Escrow
              </h3>
      ...
      {/* ── AI Predictor ────────────────────────────────────────── */}
      <section id="ai-predictor" className="py-24 bg-[#0f392b] relative overflow-hidden">
        <div
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-[24px]">
                ...
                <button className="w-full mt-6 bg-[#16a34a] hover:bg-[#15803d] text-white py-3 rounded-xl font-medium transition-colors flex items-center justify-center gap-2 text-sm">
                  <span className="material-symbols-outlined text-lg">refresh</span>
                  Recalculate Model
                </button>
              </div>

              <div className="bg-gradient-to-br from-[#16a34a]/20 to-transparent border border-[#16a34a]/20 p-6 rounded-[24px]">
              ...
              <div className="bg-black/30 backdrop-blur-xl border border-white/10 rounded-[24px] p-6 lg:p-8 shadow-2xl">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="px-3 py-1 rounded-full bg-[#16a34a]/20 border border-[#16a34a]/30 text-xs text-[#13ec80]">Weekly</span>
      ...
      <section className="py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl font-bold text-[#0f392b] mb-4"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
              Streamlined Workflow
            </h2>
          ...
          <div className="bg-gray-50 rounded-[24px] p-10 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-10 border border-gray-100">
            <div className="md:w-2/3">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2
                  className="text-2xl font-bold text-[#0f392b]"
                  style={{ fontFamily: "var(--font-playfair)" }}
                >
                  Verified by Ardhisasa
                </h2>
              ...
              <div className="flex flex-wrap gap-4">
                {["Title Deed Verification", "ID Authentication", "Fraud Detection"].map((item) => (
                  <div
                    key={item}
                    className="flex items-center gap-2 px-4 py-2 bg-white rounded-lg text-sm font-medium text-[#0f392b] shadow-sm border border-gray-200"
                  >
            ...
            <div className="md:w-1/3 flex justify-center">
              <div className="w-48 h-48 bg-white rounded-full flex items-center justify-center shadow-inner border border-gray-100">
                <span className="material-symbols-outlined text-[#0f392b]/10" style={{ fontSize: "6rem" }}>
                  policy
                </span>
              </div>
            </div>
      ...
      {/* ── Footer ──────────────────────────────────────────────── */}
      <footer className="bg-[#0f392b] pt-20 pb-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <form className="flex flex-col gap-3">
                <input
                  ...
                  className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-[#16a34a] focus:ring-1 focus:ring-[#16a34a] transition-all"
                />
                <button
                  type="submit"
                  className="bg-[#16a34a] hover:bg-[#15803d] text-white text-sm font-bold py-3 rounded-lg transition-colors shadow-lg"
                >
                  Subscribe
                </button>
              </form>
