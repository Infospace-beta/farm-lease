...
const AgreementsPage = () => {
  ...
  const agreements = [
    {
      ...
      tenant: {
        name: "Sarah Johnson",
        avatar:
          "https://lh3.googleusercontent.com/aida-public/AB6AXuBEeNaQ9ipY6hAWWDXUwBn_KT5iX0Xx6_qbKyAQKAGY5cKJrFkEEpGY8aZIJZewYzN9XKiSk_Bu75ATzV5jPRjwG4RrCJ8DaRtXbEs9gMFmh_kH-TV9Z0wlF200GtFOMO2yGGfavlW3vwurJyi85G52zDef_1NGPd46LZJ7JvsQcRpHAvWc78c4Tc6AQ5tuvf9GBGwI38AhBLDRdYl3e1tY9Zij3apSb5VGUvMQrLrdiYMEfsJlTEvwbPwiscC33L4HaPJMa4mYYPAV",
      },
      plot: {
    ...
    },
    {
      ...
      tenant: {
        name: "Jane Smith",
        avatar:
          "https://lh3.googleusercontent.com/aida-public/AB6AXuCrxrphhwqUHyCR0IxEQ_HDv3R9z3CDNvg51eW7CsOusce7YRYRwNyJPkR8akl-FZtjjwN0r3G0tjmdYEEvElAZ4EAJkaET-4gbBLZnf_dFp7-DAc3E5vz1Gexp46w68bvmUuC3Y7Sblw-h6p9HeJEhNCwJfDhKN1psyCOGzYzhCsb-5uSeBFVPCkL02DZzl5uOG_WlxRtwX1kfBZVo-bJNuKq9NRS-PyBlHtMMrqW0i2IaZfJoiGOXnfriDpbKXCFZQuxv5FA7o8JK",
      },
      plot: {
        name: "Plot B2 - East",
        acres: 2.0,
  ...
  const filteredAgreements = agreements.filter((agreement) => {
    ...
    const matchesFilter =
      filterStatus === "all" ||
      agreement.status.toLowerCase().includes(filterStatus.toLowerCase());
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-slate-500 dark:text-slate-400">
              View, manage, and download all your signed and pending lease
              agreements.
            </p>
          </div>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-slate-400 dark:text-slate-500 text-sm mt-2">
                  {filterStatus !== "all"
                    ...
                    : "New agreements will appear here"}
                </p>
              </div>
            )}
          </div>
    ...
    <div className="bg-white dark:bg-surface-dark rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-bold text-earth dark:text-white">
            {value}
          </h3>
        </div>
        <div
          className={`h-12 w-12 rounded-xl ${iconColor} flex items-center justify-center`}
        >
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
              {agreement.tenant.avatar ? (
                <div
                  ...
                  style={{
                    backgroundImage: `url('${agreement.tenant.avatar}')`,
                  }}
                ></div>
              ) : (
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <p className="font-bold text-slate-900 dark:text-white">
                Ksh {agreement.amount.toLocaleString()}
              </p>
            </div>
            <div>
