        ...
        {loading ? (
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 capitalize">
                    {profile?.role === "landowner" ? "Premium Land Owner" : (profile?.role ?? "Land Owner")}
                  </p>
                  {profile?.is_verified ? (
            ...
            <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input type="tel" className={INPUT} value={form.phone_number}
                    onChange={(e) => setForm({ ...form, phone_number: e.target.value })} />
                </div>
                <div>
                  <label className={LABEL}>County</label>
                  <input className={INPUT} value={form.county}
            ...
            <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 space-y-6">
              ...
              {pwError && (
                <div className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{pwError}</div>
              )}
            ...
            <div className="rounded-2xl border border-red-200 bg-red-50/50 p-6">
              ...
              <p className="text-sm text-slate-500 mb-4">
                Deactivating your account will remove all your listings and cease payments. This action cannot be undone.
              </p>
