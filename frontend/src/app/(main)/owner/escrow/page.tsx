                    ...
                    {e.stages.map((stage, i) => (
                      <div key={stage.label} className="flex flex-1 flex-col items-center">
                        <div className="flex w-full items-center">
                          {i > 0 && (
                            <div className={`h-0.5 flex-1 ${e.stages[i - 1].done && stage.done ? "bg-primary" :
                              e.stages[i - 1].done ? "bg-primary/30" : "bg-slate-200"
                              }`} />
                          )}
                          <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 ${stage.done
                          ...
                          {i < e.stages.length - 1 && (
                            <div className={`h-0.5 flex-1 ${stage.done && e.stages[i + 1]?.done ? "bg-primary" :
                              stage.done ? "bg-primary/30" : "bg-slate-200"
                              }`} />
                          )}
                        </div>
                        <div className="mt-2 text-center px-1">
                          <p className={`text-xs font-semibold ${stage.done ? "text-primary" : "text-slate-400"
                            }`}>{stage.label}</p>
