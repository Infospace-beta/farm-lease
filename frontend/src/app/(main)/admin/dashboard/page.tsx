  ...
  return (
    <div className="p-5 lg:p-8">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 gap-4">
        <div>
          <h2 className="text-2xl lg:text-3xl font-bold text-earth tracking-tight font-serif">
            Admin Control Center
          </h2>
          <p className="text-gray-500 text-sm mt-1 max-w-lg">
            Operational oversight, user verification queues, and system-wide
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition flex flex-col justify-between h-28"
            >
              ...
              <div>
                ...
                <div
                  className={`flex items-center gap-1 mt-1 text-xs font-medium ${
                    card.up ? "text-emerald-700" : "text-green-600"
                  }`}
                >
                  {card.up ? (
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <div className="flex justify-between items-center mb-5">
              ...
              <Link href="/admin/land-verifications" className="text-xs font-bold text-sidebar-bg hover:underline flex items-center gap-1">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-gray-100">
                    {["Owner", "Plot ID", "Submitted", "Ardhisasa Status", "Action"].map(
                      (h) => (
                        <th
                          key={h}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                ...
                <Link href="/admin/dealer-oversight" className="text-xs text-sidebar-bg font-bold hover:underline">
                  View All
                </Link>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex flex-col">
              ...
              <Link href="/admin/agreements" className="w-full py-2.5 bg-sidebar-bg text-white text-sm font-bold rounded-lg hover:opacity-90 transition flex items-center justify-center gap-2">
