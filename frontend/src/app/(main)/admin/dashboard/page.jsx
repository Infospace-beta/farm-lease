  ...
  const activityFeed = [
    {
      ...
      description:
        "Samuel K. registered as a Lessee. Awaiting email verification.",
    ...
    },
    {
      ...
      description:
        "Dispute raised on Lease ID #5529 by Tenant regarding soil quality.",
      color: "bg-red-400",
      hasLink: true,
    },
    {
    ...
    },
    {
      ...
      description:
        "Plot B12 (5 Acres) approved for listing after successful verification.",
      color: "bg-gray-400",
    },
  ];
          ...
          <nav className="space-y-1">
            {menuItems.map((item) => (
              ...
              >
                ...
                <span
                  className={`hidden lg:block text-sm ${item.active ? "" : "font-medium"}`}
                >
                  {item.label}
                </span>
                {item.badge && (
      ...
      <main className="flex-1 flex flex-col h-full bg-slate-50 overflow-hidden">
        <div className="flex-1 overflow-y-auto p-4 lg:p-8 relative">
          ...
          <header className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-3xl font-bold text-[#5D4037] mb-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button className="text-xs text-[#0f392b] font-bold hover:underline">
                      View All
                    </button>
                  </div>
