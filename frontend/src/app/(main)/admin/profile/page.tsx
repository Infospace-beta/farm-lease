      ...
      <header className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 max-w-xl">
            Manage your personal information, security preferences, and system
            access levels.
          </p>
        </div>
      </header>
            ...
            <div className="px-6 pb-6 -mt-12 flex flex-col items-center text-center">
              ...
              <div className="border-t border-gray-100 pt-4 w-full text-left space-y-3">
                {[
                  ...
                  { label: "Last Login", value: "Today, 09:41 AM", icon: History },
              ...
              {sideNav.map((item, i) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-5 py-4 text-sm font-medium border-l-4 transition-all ${
                      activeSection === i
