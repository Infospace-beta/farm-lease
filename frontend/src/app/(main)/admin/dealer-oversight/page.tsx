      ...
      <div className="flex-1 overflow-y-auto p-4 lg:p-8 bg-[#f8fafc]">
        ...
        <div className="flex items-center gap-1 mb-8 border-b border-gray-200">
          <button
            ...
            className={`px-6 py-3 text-sm font-bold border-b-2 transition-colors ${activeTab === "violations"
                  ...
                  >
                    ...
                    <td className="py-4 text-right pr-2">
                      <div className="flex justify-end gap-2">
                        ...
                        <button
                          className={`px-3 py-1.5 bg-white text-xs font-bold rounded-lg border border-gray-200 transition-colors ${dealer.status === "Suspended"
