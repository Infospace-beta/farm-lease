...
export default function AgreementsPage() {
  ...
  const filtered = contracts.filter((c) => {
    const matchTab =
      ...
      (activeTab === 2 &&
        (c.statusLabel === "Fully Signed" || c.statusLabel === "Active")) ||
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="flex flex-wrap gap-4 px-6 pt-6 border-b border-gray-100 pb-4">
            {tabs.map((tab, i) => (
              <button
                ...
                className={`text-sm font-semibold pb-1 px-1 transition-colors border-b-2 ${activeTab === i
                    ...
                    <td className="py-4 px-5 align-top text-right">
                      <div className="flex flex-col items-end gap-2">
                        <button
                          ...
                          className={`flex items-center gap-2 px-3 py-1.5 bg-sidebar-bg text-white text-xs font-bold rounded-lg shadow-sm transition ${c.canDownload
                              ? "hover:opacity-90"
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 bg-gray-50/50">
            <p className="text-xs text-gray-500">
              ...
              of <span className="font-bold text-gray-800">1,284</span>{" "}
              contracts
            </p>
            <div className="flex items-center gap-1.5">
              ...
              {[1, 2, 3].map((n) => (
                <button
                  key={n}
                  className={`w-8 h-8 flex items-center justify-center rounded-lg text-xs font-bold transition ${n === 1
