        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              ...
              Find verified agricultural land, lease with confidence, and get
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                List your agricultural land, get verified, and lease to
                qualified farmers securely.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Browse verified lands, lease with escrow protection, and get AI
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                List your agricultural products and connect with farmers across
                Kenya.
              </p>
            </div>
          </div>
