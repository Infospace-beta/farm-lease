  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 lg:p-8 relative">
      ...
      <header className="flex justify-between items-end mb-10">
        <div>
          <h2
            className="text-3xl font-bold text-[#5D4037] mb-1"
            style={{ fontFamily: "Playfair Display, serif" }}
          >
            Dashboard
          </h2>
          <p className="text-gray-500 text-sm max-w-xl">
            Monitor your lease portfolio performance, manage agreements, and
            track crop yield predictions in real-time.
          </p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button className="flex px-5 py-2.5 bg-[#0f392b] text-white rounded-lg items-center gap-2 hover:bg-opacity-90 transition shadow-lg">
                ...
                <div className="relative h-48 w-full bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl overflow-hidden mb-4 group">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      ...
                      style={{
                        clipPath: "polygon(0% 20%, 90% 0%, 100% 80%, 10% 100%)",
                      }}
                    ></div>
                  </div>
                  <div className="absolute top-3 right-3">
