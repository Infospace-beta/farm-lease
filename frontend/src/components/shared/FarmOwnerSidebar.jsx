...
const FarmOwnerSidebar = () => {
  ...
  return (
    <aside
      className={`flex flex-col border-r border-slate-800 bg-sidebar-bg overflow-y-auto z-20 shadow-sm text-white h-screen transition-all duration-300 ${
    ...
    >
              ...
              <span
                ...
                style={{
                  fontVariationSettings:
                    isActive && item.filled ? "'FILL' 1" : "'FILL' 0",
                }}
              >
                {item.icon}
              </span>
      ...
      <div className="mt-auto border-t border-white/10 p-4">
        ...
        >
          ...
          <div
            className={`flex flex-col flex-1 transition-opacity duration-300 ${
              isCollapsed ? "opacity-0 w-0 overflow-hidden" : "opacity-100"
            }`}
          >
